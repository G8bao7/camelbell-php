<?php 
class Servers_oracle_model extends CI_Model{

    protected $table='db_servers_oracle';
    ...
    function get_total_awrreport_server(){
        $this->db->where('awrreport',1);
...
/* End of file servers_mongodb_model.php */
/* Location: ./application/models/servers_mongodb_model.php */
