...
<div class="well">
	...
	<th colspan="4"><center><?php echo $this->lang->line('monitoring_switch'); ?></center></th>
        ...
        <th colspan="2"><center><?php echo $this->lang->line('repl'); ?></center></th>
    </tr>
    <tr>
	...
	<th><?php echo $this->lang->line('send_mail'); ?></th>
    	...
    	<th><?php echo $this->lang->line('awrreport'); ?></th>
...
<input type="hidden" name="ids[]" value="<?php echo $n ?>" /> 
    <tr style="font-size: 13px;">
        ...
        <td><input type="text" name="port_<?php echo $n ?>" class="input-mini" placeholder="<?php echo $this->lang->line('port'); ?>" value="1588"></td>
	...
	-->
        ...
        <td> <select name="awrreport_<?php echo $n ?>"  class="input-mini">
         <option value="1"  ><?php echo $this->lang->line('on'); ?></option>
         <option value="0"  ><?php echo $this->lang->line('off'); ?></option>
        </select></td>
