...
<div class="well">
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id=""  name="port" value="<?php echo set_value('port','1588'); ?>" >
      <span class="help-inline"></span>
    </div>
   </div>
  ...
  <!-- 
   ...
   <div class="control-group">
    ...
    <div class="controls" >
        ...
        <div class="input-prepend">
            <span class="add-on">@</span>
            <input type="text" id="send_awrreport_to_list"  class="input-xlarge" placeholder="<?php echo $this->lang->line('many_people_separation'); ?>" name="send_awrreport_to_list" value="" >
        </div>
    </div>
    </div>
