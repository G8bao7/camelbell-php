...
<div class="well">
   ...
   <hr />
    ...
    <div class="controls">
        <select name="monitor_os" id="monitor_os" class="input-small">
         <option value="1" <?php echo set_selected(1,$record['monitor_os']) ?>><?php echo $this->lang->line('on'); ?></option>
         <option value="0" <?php echo set_selected(0,$record['monitor_os']) ?>><?php echo $this->lang->line('off'); ?></option>
        </select>
    </div>
   </div>
    <div class="control-group">
   ...
   <div class="control-group">
    <label class="control-label" for=""><?php echo $this->lang->line('awrreport'); ?></label>
    <div class="controls">
        <select name="awrreport" id="awrreport" class="input-small">
         <option value="1" <?php echo set_selected(1,$record['awrreport']) ?> ><?php echo $this->lang->line('on'); ?></option>
         <option value="0" <?php echo set_selected(0,$record['awrreport']) ?> ><?php echo $this->lang->line('off'); ?></option>
        </select>
        &nbsp;&nbsp;<?php echo $this->lang->line('awrreport_send_mail_to'); ?>
        <div class="input-prepend">
            <span class="add-on">@</span>
            <input type="text" id="send_awrreport_to_list"  class="input-xlarge" placeholder="<?php echo $this->lang->line('many_people_separation'); ?>" name="send_awrreport_to_list" value="<?php echo $record['send_awrreport_to_list']; ?>" >
        </div>
    </div>
    </div>
