...
<div class="header">  
            <h1 class="page-title"><?php echo $this->lang->line('_MySQL'); ?> <?php echo $this->lang->line('batch_add'); ?></h1>
</div>
...
<form name="form" class="form-horizontal" method="post" action="<?php echo site_url('servers_mysql/batch_add') ?>" >
...
<div class="well">
   ...
   <table class="table table-hover table-bordered  ">
	...
	<tr>
        ...
        <th><?php echo $this->lang->line('replicate_ip'); ?></th>
        <!--
...
<input type="hidden" name="ids[]" value="<?php echo $n ?>" /> 
    <tr style="font-size:12px;">
        ...
        <td><input type="text" name="port_<?php echo $n ?>" class="input-mini" placeholder="<?php echo $this->lang->line('port'); ?>" value="3388"></td>
        <td><input type="text" name="replicate_ip_<?php echo $n ?>" class="input-small" placeholder="<?php echo $this->lang->line('replicate_ip'); ?>" value="-"></td>
	<!--
	...
	-->
        ...
        <td> <select name="slow_query_<?php echo $n ?>"  class="input-mini">
         <option value="1"  ><?php echo $this->lang->line('on'); ?></option>
         <option value="0"  ><?php echo $this->lang->line('off'); ?></option>
        </select></td>
