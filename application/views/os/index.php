...
<div class="well">
 ...
 <?php foreach ($datalist  as $item):?>
    <tr style="font-size: 12px;">
        ...
        <td><?php if($item['zabbix']=='1'){ ?> <span class="label label-success"><?php echo $this->lang->line('success'); ?></span> <?php }else{  ?><span class="label label-important"><?php echo $this->lang->line('failure'); ?></span> <?php } ?></td>
	...
	<td><?php echo check_value($item['disk_io_reads_total']) ?></td>
        <td><?php echo check_value($item['disk_io_writes_total']) ?></td>
	<td><?php echo format_bytes($item['net_in_bytes_total']) ?></td>
        <td><?php echo format_bytes($item['net_out_bytes_total']) ?></td>
	<td><?php echo $item['create_time'] ?></td>
        <td><?php if($item['zabbix']=='1'){ ?><a href="http://172.21.200.27/zabbix/latest.php"><img src="./images/chart.gif"/></a> <?php }else{  ?>--- <?php } ?></td>
	</tr>
 <?php endforeach;?>
 <?php }else{  ?>
<tr>
