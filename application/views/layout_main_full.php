  ...
  <div class="main">
       <?php echo $content_for_layout ; ?>
                    ...
                    <footer>
                        ...
                        <p class="pull-right">Power by <a href="#" target="_blank">Lepus</a></p>

                        <p>&copy; 2016 <a href="#" target="_blank">Lepus</a>(<?php echo $this->lang->line('lepus'); ?> <?php echo $this->lang->line('database_monitor_system'); ?>)</p>
                    </footer>
