...
<div class="control-group success">
   ...
   <div class="control-group success">
    ...
    <div class="controls">
        ...
        &nbsp;&nbsp;<?php echo $this->lang->line('monitor_os_method'); ?>&nbsp;

        <select name="monitor_os_method" id="monitor_os_method" class="input-small">
         <option value="salt" <?php echo set_selected("salt",$settings['monitor_os_method']) ?> >salt</option>
         <option value="zabbix" <?php echo set_selected("zabbix",$settings['monitor_os_method']) ?>  >zabbix</option>
         <option value="snmpwalk" <?php echo set_selected("snmpwalk",$settings['monitor_os_method']) ?> >snmpwalk</option>
   ...
   <div class="control-group success">
    <label class="control-label" for="">*<?php echo $this->lang->line('frequency_sync_os'); ?></label>
    <div class="controls">
        <select name="frequency_sync_os" id="frequency_sync_os" class="input-medium">
         <option value="30" <?php echo set_selected(30,$settings['frequency_sync_os']) ?>>30 <?php echo $this->lang->line('date_seconds'); ?></option>
         <option value="60" <?php echo set_selected(60,$settings['frequency_sync_os']) ?>>1 <?php echo $this->lang->line('date_minutes'); ?></option>
         <option value="120" <?php echo set_selected(120,$settings['frequency_sync_os']) ?>>2 <?php echo $this->lang->line('date_minutes'); ?></option>
         <option value="180" <?php echo set_selected(180,$settings['frequency_sync_os']) ?>>3 <?php echo $this->lang->line('date_minutes'); ?></option>
         <option value="300" <?php echo set_selected(300,$settings['frequency_sync_os']) ?>>5 <?php echo $this->lang->line('date_minutes'); ?></option>
        </select>
        <span class="help-inline"></span>
    </div>
   </div>
   ...
   <div class="control-group success">
    <label class="control-label" for="">*<?php echo $this->lang->line('min_interval'); ?></label>
    <div class="controls">
      <input type="text" id="min_interval"  name="min_interval" value="<?php echo $settings['min_interval'] ?>" class="input-large"><?php echo $this->lang->line('date_seconds'); ?>
    </div>
   </div>
