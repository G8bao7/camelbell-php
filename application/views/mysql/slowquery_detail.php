...
<div class="btn-toolbar">
    ...
    <a class="btn btn-success " href="<?php echo site_url('lp_mysql/slowquery_ignore/'.$record['checksum']) ?>"><i class="glyphicon glyphicon-eye-close"></i> <?php echo $this->lang->line('ignore'); ?></a>
    -->
    ...
    <a class="btn btn-primary " href="<?php echo site_url('lp_mysql/slowquery_index/'.$record['checksum']) ?>"><i class="icon-on"></i><?php echo $this->lang->line('slowquery_index'); ?></a>
    <a class="btn btn-info " href="<?php echo site_url('lp_mysql/slowquery_ignore/'.$record['checksum']) ?>"><i class="icon-on"></i><?php echo $this->lang->line('ignore'); ?></a>
    <a class="btn btn-warning " href="<?php echo site_url('lp_mysql/slowquery_optimize_dev/'.$record['checksum']) ?>"><i class="icon-on"></i><?php echo $this->lang->line('optimize_dev'); ?></a>
...
<table class="table  table-bordered table-condensed" style="font-size: 12px;table-layout:fixed;" >
    <tr>
        ...
        <td colspan="1"><?php echo $record['user_max']; ?></td>
        <th><?php echo $this->lang->line('status'); ?></th>	
        <td colspan="1">
<?php if($record['cur_status']==5){echo $this->lang->line('slowquery_index');}elseif($record['cur_status']==100){echo $this->lang->line('ignore');}elseif($record['cur_status']==200){echo $this->lang->line('optimize_dev');}else{echo $this->lang->line('slowquery_none');} ?>
	</td>
	</tr>
    <tr>
