<div class="header">
  <h1 class="page-title"><?php echo $this->lang->line('mysql'); ?> <?php echo $this->lang->line('_SQL Audit'); ?></h1>
</div>
...
<form name="form" class="form-horizontal" method="post" action="<?php site_url('lp_mysql/sql_audit') ?>" >
