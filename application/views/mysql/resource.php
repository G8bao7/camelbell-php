...
<form name="form" class="form-inline" method="get" action="" >
  ...
  <option value="threads_created" <?php if($setval['order']=='threads_created') echo "selected"; ?> ><?php echo $this->lang->line('threads_created'); ?></option>
...
<div class="well">
    <table class="table table-hover table-condensed ">
      <thead>
       <tr style="font-size: 12px;">
		...
		<th colspan="3"><center><?php echo $this->lang->line(''); ?></center></th>
        ...
        <th><?php echo $this->lang->line('innodb_stats_on_metadata'); ?></th>
        <th><?php echo $this->lang->line('innodb_flush_log_at_trx_commit'); ?></th>
        <th><?php echo $this->lang->line('sync_binlog'); ?></th>
	<th><?php echo $this->lang->line('max_connections'); ?></th>
        <th><?php echo $this->lang->line('threads_connected'); ?></th>
        <th><?php echo $this->lang->line('threads_created'); ?></th>
 ...
 <?php foreach ($datalist  as $item):?>
    <tr style="font-size: 12px;">
        ...
        <td><?php echo check_metadata($item['innodb_stats_on_metadata']) ?></td>
        <td><?php echo check_trx_commit($item['innodb_flush_log_at_trx_commit']) ?></td>
        <td><?php echo check_sync_binlog($item['sync_binlog']) ?></td>
	<td><?php echo $item['max_connections'] ?></td>
        <td><?php echo check_pct($item['threads_connected'], $item['max_connections'], 80) ?></td>
        <td><?php echo $item['threads_created'] ?></td>
