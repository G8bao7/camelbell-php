...
<html lang="en">
  <head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="lib/bootstrap/css/bootstrap3.css">-->
  ...
  <!--<![endif]-->
    ...
    <div class="navbar" <?php if($this->input->cookie('lang_current')=='zh-hans') echo  "style='font-family: 微软雅黑;'" ?>>
        <div class="navbar-inner">
		    ...
		    ?>
                    ...
                    <li <?php if($model=='tools'){ echo "class='active'";} ?>><a href="<?php echo site_url('tools/index'); ?>" class="hidden-phone visible-tablet visible-desktop" role="button"><?php echo $this->lang->line('tools'); ?></a></li>
    ...
    <div class="sidebar-nav" <?php if($this->input->cookie('lang_current')=='zh-hans') echo  "style='font-family: 微软雅黑;'" ?> >
        ...
        <a href="http://172.21.100.200/camelbells" target="_blank" class="nav-header" ><i class="icon-question-sign"></i><?php echo $this->lang->line('help'); ?></a>
	...
	<footer>
	    ...
	    <p class="pull-right">Power by <a href="#" target="_blank">CamelBells</a></p>

	    <p>&copy; 2016 <a href="#" target="_blank">CamelBells</a>(<?php echo $this->lang->line('lepus'); ?> <?php echo $this->lang->line('database_monitor_system'); ?>)</p>
	</footer>
