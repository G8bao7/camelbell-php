...
<div class="header">  
            <h1 class="page-title"><?php echo $this->lang->line('_MongoDB'); ?> <?php echo $this->lang->line('batch_add'); ?></h1>
</div>
...
<form name="form" class="form-horizontal" method="post" action="<?php echo site_url('servers_mongodb/batch_add') ?>" >
...
<div class="well">
   ...
   <table class="table table-hover table-bordered  ">
	...
	-->
		...
		<th><?php echo $this->lang->line('monitor_os'); ?></th>
...
<input type="hidden" name="ids[]" value="<?php echo $n ?>" /> 
    <tr style="font-size:12px;">
        ...
        <td><input type="text" name="port_<?php echo $n ?>" class="input-mini" placeholder="<?php echo $this->lang->line('port'); ?>" value="27017"></td>
	<!--
	...
	-->
        ...
        <td><select name="monitor_os_<?php echo $n ?>"  class="input-mini">
         <option value="1"  ><?php echo $this->lang->line('on'); ?></option>
         <option value="0"  ><?php echo $this->lang->line('off'); ?></option>
        </select></td>
        ...
        <td><select name="alarm_connections_current_<?php echo $n ?>"  class="input-mini">
         <option value="1"  ><?php echo $this->lang->line('on'); ?></option>
         <option value="0"  ><?php echo $this->lang->line('off'); ?></option>
        </select></td>
        <td><select name="alarm_active_clients_<?php echo $n ?>"  class="input-mini">
         <option value="1"  ><?php echo $this->lang->line('on'); ?></option>
         <option value="0"  ><?php echo $this->lang->line('off'); ?></option>
        </select></td>
        <td><select name="alarm_current_queue_<?php echo $n ?>"  class="input-mini">
         <option value="1"  ><?php echo $this->lang->line('on'); ?></option>
         <option value="0"  ><?php echo $this->lang->line('off'); ?></option>
        </select></td>
	</tr>
